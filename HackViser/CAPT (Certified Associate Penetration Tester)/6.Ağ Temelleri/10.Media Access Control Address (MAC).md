...
(Internet Protocol Configuration), linux tabanlı işletimsistemlerinde

ifconfig

(Interface Config) komutu ile bilgisayarınıza atana IP, alt ağ maskesi ve Varsayılan ağ geçidi bilgileri görülür.
