...
1. **Ağ Arayüzü Katmanı (Network Interface Layer):** 
	Fiziksel ve veri bağlantı katmanlarının işlevlerini birleştirir ve donanım üzerinden veri iletimini sağlar.

2. **İnternet Katmanı (Internet Layer):** 
	Ağ katmanına karşılık gelir ve IP adreslerini kullanarak verilerin yönlendirilmesini sağlar.

3. **Taşıma Katmanı (Transport Layer):** 
	OSI modelindeki gibi uçtan uca iletişimi yönetir ve TCP ile UDP protokollerini içerir.

4. **Uygulama Katmanı (Application Layer):** 
	OSI modelindeki oturum, sunum ve uygulama katmanlarının işlevlerini birleştirir. Kullanıcıların ağ uygulamalarıyla etkileşimini sağlar.
